...
<head>
    ...
    <title>Ajouter un Nouveau Prédécesseur</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="card p-4 form-container">
            <h1 class="text-center">Ajouter un Nouveau Prédécesseur</h1>
            <form action="/add-preselector" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-success w-100">Ajouter Prédécesseur</button>
            </form>
        </div>
    </div>
